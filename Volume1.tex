...
Da ottobre 2025 sono rappresentante degli studenti del Dipartimento di Scienze Matematiche, Informatiche e Fisiche, ma soprattutto, \textbf{sono uno che ha fatto tutti gli errori possibili.}
...
Se sei di IBML, alcuni di questi consigli sono adatti anche a te.
...
\end{itemize}
Quando parlo di ``università'', mi riferisco esclusivamente a questi due corsi. Non posso parlare per altri corsi di laurea o altri atenei.
...
I miei peer reviewer e ogni contributore passato, presente e futuro è esente da ogni responsabilità.\\

\section{Contributi e aggiornamenti}
Le informazioni sono aggiornate a \textbf{Marzo 2026}. Alcuni dettagli potrebbero cambiare nel tempo.\\
...
Partiamo dalle basi: per studiare Informatica, ti servirà un portatile fin dal primo anno.\\
Dovrai scrivere codice ed eseguirlo.\\
...
Da smanettone appassionato di hardware, di open source e configurazioni PC mi brucia un sacco ammetterlo, ma al momento, \textbf{non esiste} un portatile Windows che batta un \textbf{Macbook Air M5 base} per uso universitario.\\ Sottolineo però che i modelli precedenti, fino all'M1 vanno  benissimo. È un discorso troppo ampio da discutere in questa guida quindi guarda le recensioni e fatti la tua opinione. In generale non avrai bisogno di chissà che potenza di calcolo. Se il budget te lo permette, punta su queste cose:

\begin{itemize}
\item Efficienza,
\item Leggerezza e comodità,
\item Durata della batteria,
\item Ricarica con USB-C
\end{itemize}


\subsection{Fascia di prezzo consigliata}
In generale, i macbook Air nuovi su Amazon arrivano spesso intorno ai 950 euro.  
I modelli precedenti all'M5 si trovano a molto meno e sono altrettanto validi.\\
...
\begin{itemize}
\item Evita qualunque Macbook fuori dal modello Air base. La potenza dell'M1 è già più che sufficiente.
\item Non aggiungere memoria in fase di configurazione, piuttosto usa un ssd esterno.
\end{itemize}%
\textbf{Evita come la peste i pc con processori ARM come gli Snapdragon:}
\begin{itemize}
\item Non sono ancora maturi.
\item Per quanto mi riguarda, se non è Intel, AMD o Apple Silicon lo sconsiglio.
\end{itemize}%
\textbf{Evita i portatili da gaming:}
Sono pesanti, ingombranti, rumorosi ed hanno un'autonomia reale ridicola.\\ 
Possono avere senso \textbf{solo} se prevedi di usarli anche per gaming o rendering.


\subsection{Ma se proprio vuoi un portatile Windows o Linux}
Cerca un portatile con:
\begin{itemize}
\item \textbf{Processore AMD Ryzen 5 o Intel i5} o superiore di generazione recente ma anche quelle più vecchie vanno bene.
...
\end{itemize}%
Se scegli Windows, \textbf{preparati a installare Ubuntu} o una qualsiasi altra distribuzione Linux in dual boot, su macchina virtuale o ad usare la WSL: ti servirà per Sistemi Operativi e molti esercizi in bash o C.\\ Ti consiglio di dare un'occhiata ai \textbf{Lenovo ThinkPad}. In generale sono delle ottime macchine. Costano un pò ma hanno i loro vantaggi:
\begin{itemize}
...
\item Se non ti vengono date informazioni sugli esami alla prima lezione, sentiti libero di chiederle.
\end{itemize}
...
\begin{itemize}
\item Perdi il contatto con gli altri studenti, e con i professori
\item Ti distrai più facilmente perché nulla ti impedisce di abbandonare la lezione in qualunque momento.
\end{itemize}%
Le lezioni registrate sono un mezzo potente, ma vanno usate con attenzione.
...
\end{quote}%
È un lavoro lunghissimo che ti fa sentire soddisfatto e ti dà la falsa sensazione di aver capito o imparato tutto. 
...
La cosa veramente utile è \textbf{capire il significato} e soprattutto \textbf{fare esercizi} su quello che studi.\\
Se non sai come studiare, ti consiglio queste due tecniche che per me e il mio gruppo hanno funzionato molto bene.\\
...
Esplora l'università, scopri le backrooms con i girasoli e le luci UV sottoterra e le cassette entomologiche ai piani superiori.
\begin{quote}
\textbf{Sii curioso, ma non metterci più di 10 minuti.}
\end{quote}
Durante la pausa il tuo cervello elabora le informazioni apprese nei 40 minuti precedenti.
\begin{quote}
...
\textbf{Durata ottimale: 10-20 minuti.}\\
Devi riuscire a non entrare nella fase del sonno profondo, altrimenti ti sveglierai più stanco di prima per un fenomeno chiamato ``sleep inertia''.\\
...
\end{itemize}%
\textbf{Metti la sveglia sempre}, anche se pensi di non addormentarti. Mettine più di una per essere sicuro.
...
\section{LLM e intelligenza artificiale}
ChatGPT e gli altri Large Language Models possono darti una grossa mano nello studio. Ma devi usarli con attenzione, perché possono anche fare parecchi danni.\\
Le cose in quest'ambito cambiano ogni giorno quindi informati e fai le tue considerazioni.

\subsection{Come usare l'IA per studiare}
\begin{quote}
\textbf{L'IA è uno strumento, non una scorciatoia per evitare di studiare.}
\end{quote}
Non fidarti delle risposte senza verificarle.\\
...
\item Studia in gruppo. Se ha ingannato te, non è detto che riesca a fregare anche i tuoi compagni.
\end{itemize}
...
\item \href{https://it.symbolab.com/}{Symbolab}: Alternativa per step-by-step
...
Se devi usare l'IA, almeno usala bene. Il modo in cui formuli la domanda può fare la differenza. (Attenzione perché non è una scienza esatta)\\
Dai un'occhiata alla \href{https://github.com/anthropics/prompt-eng-interactive-tutorial}{repository ufficiale di Anthropic} per imparare a scrivere prompt decenti.\\
Se vuoi saperne di più e rimanere aggiornato, ci sono un milione di fonti da cui puoi attingere, ma per il momento, ti consiglio il canale youtube di \href{https://www.youtube.com/@enkk}{Enkk}


\subsection{Come creare flashcards con l'IA}
Se proprio vuoi usare l'IA per scrivere le flashcards, assicurati di:
\begin{itemize}
\item Scrivere un prompt efficace,
\item Dare all'LLM i file con le fonti necessarie,
\item Processare \textbf{un capitolo per volta} per non diluire troppo la risposta dell'IA,
\item Controllare sempre che domande e risposte abbiano senso,
\item Personalizzare le flashcards aggiungendo esempi tuoi,
\item Testare le flashcards con i compagni per vedere se sono chiare,
\end{itemize}
...
Gli imprevisti capitano spesso.
\begin{quote}
...
La maggior parte dei professori mette a disposizione prove vecchie ed sercizi svolti.\\
...
\item Prega per un miracolo.
\end{itemize}
\begin{quote}
\textbf{Se manca una settimana all'esame e non hai ancora provato a fare vecchi esaami, sei in ritardo.}
\end{quote}
Può essere utile cronometrarsi durante lo svolgimento di una vecchia prova d'esame (vedi quiz di Logica Matematica).
...
Corri pure i tuoi rischi, ma considera che potresti andare in vacanza dopo l'esame di settembre, quando fa meno caldo, c'è meno gente in giro e soprattutto hai la mente libera.\\
...
Perciò ti avviso:
\begin{quote}
Se sei uno che copia abitualmente, lo capisco: ti senti messo alle strette, magari credi sia l'unico modo per superare le difficoltà dell'esame, ma sei ancora in tempo per cambiare idea. Ti ho dato un sacco di consigli, ma se proprio non riesci ad andare avanti, puoi parlare con i tutor, con i dottorandi e con i professori. Sono tutti disposti ad aiutarti se gliene dai la possibilità. Se però sei convinto di continuare a copiare, io farò di tutto per fermarti.\\
...
\begin{itemize}
\item Alessandro
\item \href{https://github.com/maz-srs}{maz-srs}
